...
class ZeroCostDeployment:
    ...
    async def start_services(self):
        ...
        # Cambié la importación aquí
        from app.services.integration_bridge import FileProcessorEnhanced  # Nueva importación
    ...
    async def cleanup_loop(self):
        ...
        while self.is_running:
            try:
                ...
                if 'processor' in self.services:
                    from app.services.integration_bridge import FileProcessorMicroservice  # Nueva importación
